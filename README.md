...
[![Designs](https://img.shields.io/badge/designs-68-green?style=flat-square)](https://luongnv.com/sleek-ui)

# Professional design systems for your AI agent

68 production-grade design systems — Stripe, Linear, Vercel, Notion and more — as clean JSON. Give your agent one URL and it applies colors, typography, spacing, and component styles.
...
68 designs covering brand-faithful recreations and original systems:
